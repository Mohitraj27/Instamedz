...
public class Eyecare_ex2 extends Home_Page {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.activity_eyecare_ex2, null, false);
    ...
    public void EyeCareEx3(View view) {
        Intent Eyecareex=new Intent(Eyecare_ex2.this, Eyecare_ex3.class);
        startActivity(Eyecareex);
    }

    public void EyeCareEx1(View view) {
        Intent Eyecareex=new Intent(Eyecare_ex2.this, Eyecare_ex1.class);
        startActivity(Eyecareex);
    }
}